...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        var botEmbed = new discord.MessageEmbed()
            ...
            .setDescription(`    
             **When:** Friday
             **Time:** 7PM GMT+2 (amsterdam)
             
             Please react to let us know if u can be here.
             If u can't, dm Aspect with the reason why.
             React on this message please.`)
            .setColor("#ff8ce6")
        ...
        message.author.send(`${message.author} You have rejected ${dUser} p`)
